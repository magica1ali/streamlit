...
st.write(f”Hello {name}!  Welcome to  theMachine Learning Application designed by Ali Mohamed. 
This application was specifically designed to predict if a person is a LinkedIn user.  Please complete
the survey below to get a prediction.”)

# "### Slider"
st.write(f"{name}" please select the age of the person)
age = st.slider("Select an number”, 1, 97, 1")
