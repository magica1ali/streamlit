...
### Slider
with st.container():
        st.write(f'{name}, please select highest level of school/degree completed from educaiton level below:')
        st.write(pd.DataFrame({
        'Education Level': [1,2,3,4,5,6,7,8],
        'Degree Completed': ['Less than high school','High school incomplete','Some college, no degree','Two-year associate degree from a college or university','Four-year college or university degree',
